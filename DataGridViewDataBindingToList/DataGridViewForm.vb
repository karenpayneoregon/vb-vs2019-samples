...
Imports DataGridViewDataBindingToList.Components
Imports DataGridViewDataBindingToList.Extensions.DataGridViewExtensions
...
Public Class DataGridViewForm
    ...
    Private Sub DataGridViewForm_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Dim customerFileName = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "CustomersWithPrimaryAndCountryPrimaryKey.csv")

        Dim results As (List As List(Of Customer), Exception As Exception) = FileOperations.ReadCustomerFile(customerFileName, CountryList)
    ...
    Private Sub SaveChangesButton_Click(sender As Object, e As EventArgs) Handles SaveChangesButton.Click
        ...
        Dim customerFileName = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "CustomersWithPrimaryAndCountryPrimaryKey.csv")
        Dim test = CType(CustomersBindingSource.DataSource, SortableBindingList(Of Customer)).ToList()
        FileOperations.SaveCustomers(customerFileName, test)
