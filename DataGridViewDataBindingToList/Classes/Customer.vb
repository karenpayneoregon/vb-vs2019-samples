...
Namespace Classes
    Public Class Customer
        ...
        Public ReadOnly Property ItemArray() As String
            Get
                Return $"{CustomerIdentifier},{CompanyName.Fixer()}," &
                       $"{ContactTitle.Fixer()},{ContactName.Fixer()},{City.Fixer()},{CountryIdentifier}"
            End Get
        End Property
